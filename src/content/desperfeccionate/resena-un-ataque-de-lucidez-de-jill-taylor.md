---
title: 'Reseña: Un ataque de lucidez, de Jill Taylor'
description: 'Reseña del libro "Un ataque de lucidez", de Jill Taylor. En este libro, Jill explica como un ictus cambió su vida... para bien. No es tanto una historia de superación, como una historia de transformación, la cual considero bastante más valiosa.'
pubDate: 'Nov 10 2020'
heroImage: '../../assets/desperfeccionate/resena-un-ataque-de-lucidez-de-jill-taylor/Un-ataque-de-lucidez.jpg'
---
## Un libro diferente
...
A parte del abordaje de esta dicotomía, algo ya de por si muy jugoso, ***[Un ataque de lucidez](https://www.casadellibro.com/libro-un-ataque-de-lucidez/9788483068113/1234191)*** se trata de un libro muy especial porque así lo es el evento o circunstancia que da lugar a su posterior publicación.

Varios años antes de plantearse siquiera la escritura del libro, **[Jill](https://www.ted.com/talks/jill_bolte_taylor_my_stroke_of_insight/transcript?language=es)** era neuróloga en Harvard, miembro de la junta nacional de la **[Alianza Nacional para las Enfermedades Mentales (NAMI)](https://namipv.org/espanol/)** y recorría el país como **[la Científica Cantante](https://www.ted.com/talks/jill_bolte_taylor_my_stroke_of_insight?language=es)**. Esto ya nos da una idea de que se trata de una persona excepcional. Mujer exitosa en el apartado profesional y muy dedicada a causas sociales. El ejemplo de persona perfecta, vaya. Dedicada a triunfar para sí misma y para los demás. Un modelo a seguir, según las creencias dominantes actuales.
